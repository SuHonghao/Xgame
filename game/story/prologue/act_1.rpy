label prologue_mansion:
    scene expression prologue_asset("images/background/chen_house_evening.png") with fade
    ...
    $ quick_menu = True
    show mother normal at portrait_left with dissolve
    mother "九啊，又出去？"

    hide mother normal
    show chenjiu normal at portrait_left with dissolve
